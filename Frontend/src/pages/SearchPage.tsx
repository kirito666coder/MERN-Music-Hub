                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {songs.map((song) => (
                            <motion.div
                                key={song._id}
                                className="relative rounded-lg overflow-hidden shadow-sm cursor-pointer border border-gray-200 dark:border-gray-700 group"
                            ...
                            >
                                ...
                                <div className="w-full h-40 relative">
                                    ...
                                    {/* Black overlay (fade only) */}
                                    <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity" />

                                    {/* PlayButton (scale + fade) */}
                                    <motion.div
